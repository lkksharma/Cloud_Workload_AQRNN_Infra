...
def run_simulation():
    ...
    for r in range(N_ROUNDS):
        ...
        # Step 4: Train each client on their ASSIGNED expert
        for c in tqdm(clients, desc="Clients Training"):
            assigned_k = client_assignment[c.client_id]
            
            # Step B: Train ONLY the assigned expert
            chosen_params = server.experts[assigned_k]
            updated_params, train_loss = c.train_epoch(chosen_params, qnode, n_x, N_H, HIDDEN_DIM, LR_Q, LR_C)
